...
SWEP.SwitchModel = "models/MaxOfS2D/button_01.mdl"
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		...
		ElecSpawn(vec, trace.HitNormal:Angle() - Angle( 270, 0, 0 ))
...
function SWEP:Think()
	...
	if ( !IsValid( self.GhostEntity ) ) then
		self:MakeGhostEntity( self.SwitchModel, Vector( 0, 0, 0 ), Angle( 0, 0, 0 ) )
	end
...
function SWEP:UpdateGhostEntity( ent, player )
	...
	ent:SetPos( vec )
	ent:SetAngles( trace.HitNormal:Angle() - Angle( 270, 0, 0 )  )
